  ...
  return (
    ...
    <nav className="bg-white fixed w-full z-20 top-0 left-0 border-b border-gray-200">
      ...
      <div  className="flex items-center ">
          <img src={logo} className="h-16 mr-3" alt="medstore logo"/>
          <span className="self-center text-2xl font-semibold whitespace-nowrap ">Medstore Talents</span>
          </div>
      <div className="flex md:order-2">
          ...
          <button data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " aria-controls="navbar-sticky" aria-expanded="true">
