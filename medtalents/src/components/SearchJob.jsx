...
const SearchJob = () => {
  ...
  return (
    ...
    <div className='flex m-5'>
        <input type="text" placeholder='Search job' className='border rounded-md px-3'/><span><BsSearch size={28} className='border rounded-md cursor-pointer hover:bg-slate-400'/></span>
    </div>
    <div className='py-5'>
        <div className='flex'>
    <input
